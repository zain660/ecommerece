...
<div class="CHAT_MESSAGE_POPUPBOX">
                ...
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="{{showImage('backend/img/chat/2.png')}}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="{{showImage('backend/img/chat/1.png')}}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="{{showImage('backend/img/chat/4.png')}}" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="{{showImage('backend/img/chat/5.png')}}" alt="">
                        </div>
                    </a>
                </li>
                <li>
    ...
    <div class="CHATING_SENDER">
        <div class="SMS_thumb">
            <img src="{{showImage('backend/img/chat/sender.png')}}" alt="">
        </div>
