                            ...
                            @foreach ($orders as $key => $order)
                                <div class="white_box style2 bg-white mb_20">
                                    <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                        ...
                                        <div class="d-flex flex-column  ">
                                            <a class="amaz_primary_btn gray_bg_btn min_200 radius_3px" download="" href="{{ route('frontend.my_purchase_order_pdf', encrypt($order->id)) }}" target="_blank">{{__('defaultTheme.download_invoice')}}</a>
                                        </div>
                                    </div>
