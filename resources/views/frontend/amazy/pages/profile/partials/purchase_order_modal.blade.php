                            ...
                            <div class="subtotal_and_payment_information d-flex flex-wrap gap-3">
                                <div class="thumb flex-fill">
                                    @if($package->order->order_payment->payment_method == 1)
                                        <img class="img-fluid" src="{{url('/')}}/frontend/amazy/img/amazPorduct/cash_on_delivery.png " alt="{{$package->order->order_payment->GatewayName}}" title="{{$package->order->order_payment->GatewayName}}">
                                    @else
