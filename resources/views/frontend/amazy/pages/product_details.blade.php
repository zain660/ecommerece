...
@section('share_meta')
    ...
    @elseif(
        @$product->product->thumbnail_image_source != null &&
            @getimagesize(showImage(@$product->product->thumbnail_image_source))[0] > 200)
        <meta property="og:image" content="{{ showImage(@$product->product->thumbnail_image_source) }}" />
    @elseif(count(@$product->product->gallary_images) > 0 &&
            @getimagesize(showImage(@$product->product->gallary_images[0]->images_source))[0] > 200)
...
@section('content')
    ...
    <div class="product_details_wrapper">
        <div class="container">
            <div class="row">
                <div class="col-xl-9">
                    <div class="row">
                        <div class="col-lg-6 col-xl-6">
                            <div class="slider-container slick_custom_container mb_30" id="myTabContent">
                                <div class="slider-for gallery_large">
                                    @if (count($product->product->gallary_images) > 0)
                                        @foreach ($product->product->gallary_images as $image)
                                            <div class="item-slick {{ $product->product->gallary_images->first()->id == $image->id ? 'slick-current slick-active' : '' }}"
                                                id="thumb_{{ $image->id }}">
                                                <img class="varintImg zoom_01" src="{{ showImage($image->images_source) }}"
                                    ...
                                    @else
                                        <div class="item-slick slick-current slick-active" id="thumb_{{ $product->id }}">
                                            <img class="varintImg zoom_01"
                                                @if ($product->thum_img != null) data-zoom-image="{{ showImage($product->thum_img) }}" @else data-zoom-image="{{ showImage($product->product->thumbnail_image_source) }}" @endif
                                                @if ($product->thum_img != null) src="{{ showImage($product->thum_img) }}" @else src="{{ showImage($product->product->thumbnail_image_source) }}" @endif
                                ...
                                <div class="slider-nav">
                                    ...
                                    @else
                                        <div class="item-slick slick-active slick-current">
                                            <img @if ($product->thum_img != null) src="{{ showImage($product->thum_img) }}" @else src="{{ showImage($product->product->thumbnail_image_source) }}" @endif
                                                alt="{{ $product->product_name }}" title="{{ $product->product_name }}">
                                        </div>
                                    @endif
                                </div>
                                ...
                                <input type="hidden" name="thumb_image" id="thumb_image"
                                    value="{{ showImage($product->thum_img ? $product->thum_img : $product->product->thumbnail_image_source) }}">
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6">
                            <div class="product_content_details mb_20">
                                <div id="stock_div">
                                    @if (
                                        $product->stock_manage == 1 &&
                                            @$product->skus->where('status', 1)->first()->product_stock >= @$product->product->minimum_order_qty)
                                ...
                                <div class="viendor_text d-flex align-items-center">
                                    <p class="stock_text"> <span
                                            class="text-uppercase">{{ __('defaultTheme.sku') }}:</span> <span
                                            class="stock_value" id="sku_id_li">
                                            {{ @$product->skus->where('status', 1)->first()->sku->sku ?? '-' }}</span></p>
                                ...
                                <div class="viendor_text d-flex align-items-center">
                                    <p class="stock_text"> <span
                                            class="text-uppercase">{{ __('defaultTheme.availability') }}:</span> <span
                                            class="stock_value" id="availability">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="product_ratings mb-2">
                                        ...
                                        <span>{{ getNumberTranslate(sprintf('%.2f', $rating)) }}/{{ getNumberTranslate(5) }}
                                            ({{ $total_review < 10 && $total_review > 0 ? '0' : '' }}{{ getNumberTranslate($total_review) }}
                                            {{ __('defaultTheme.review') }})</span>
                                    </div>
                                        ...
                                        <div class="border-start ps-3 ms-3">
                                            <span class="d-flex align-items-center point">
                                                <svg width="16" height="14" viewBox="0 0 16 14" fill="none">
                                                    <path
                                                        d="M15 7.6087V10.087C15 11.1609 12.4191 12.5652 9.23529 12.5652C6.05153 12.5652 3.47059 11.1609 3.47059 10.087V8.02174M3.71271 8.2357C4.42506 9.18404 6.628 10.0737 9.23529 10.0737C12.4191 10.0737 15 8.74704 15 7.60704C15 6.96683 14.1872 6.26548 12.9115 5.77313M12.5294 3.47826V5.95652C12.5294 7.03044 9.94847 8.43478 6.76471 8.43478C3.58094 8.43478 1 7.03044 1 5.95652V3.47826M6.76471 5.9433C9.94847 5.9433 12.5294 4.61661 12.5294 3.47661C12.5294 2.33578 9.94847 1 6.76471 1C3.58094 1 1 2.33578 1 3.47661C1 4.61661 3.58094 5.9433 6.76471 5.9433Z"
                                ...
                                <div class="destils_prise_information_box mb_20">
                                    ...
                                    <input type="hidden" name="product_sku_id" id="product_sku_id"
                                        value="{{ $product->product->product_type == 1 ? $product->skus->where('status', 1)->first()->id : $product->skus->where('status', 1)->first()->id }}">
                                ...
                                @if ($product->product->product_type == 2 && session()->get('item_details') != '')
                                    @foreach (session()->get('item_details') as $key => $item)
                                        @if ($item['attr_id'] === 1)
                                            <div class="product_color_varient mb_20">
                                                <h5 class="font_14 f_w_500 theme_text3  text-capitalize d-block mb_10"
                                                    id="color_name">{{ $item['name'] }}: {{ $item['value'][0] }} </h5>
                                                <div class="color_List d-flex gap_5 flex-wrap">
                                                    ...
                                                    @foreach ($item['value'] as $k => $value_name)
                                                        <label class="round_checkbox d-flex">
                                                            <input id="radio-{{ $k }}" name="color_filt"
                                                                class="attr_val_name  radio_{{ $item['id'][$k] }}"
                                                                type="radio" color="color"
                                                                ...
                                                                value="{{ $value_name }}" />
                                                            <span
                                                                class="checkmark colors_{{ $k }} class_color_{{ $item['code'][$k] }}">
                                        ...
                                        @if ($item['attr_id'] != 1)
                                            <div class="product_color_varient mb_20">
                                                <h5 class="font_14 f_w_500 theme_text3  text-capitalize d-block mb_10"
                                                    id="size_name{{ $key }}">{{ $item['name'] }}:
                                                    {{ $item['value'][0] }}</h5>
                                                <div class="color_List d-flex gap_5 flex-wrap">
                                                    <input type="hidden" class="attr_value_name"
                                                        data-name="{{ $item['name'] }}" name="attr_val_name[]"
                                                        value="{{ $item['value'][0] }}">
                                                    <input type="hidden" class="attr_value_id" name="attr_val_id[]"
                                                        value="{{ $item['id'][0] }}-{{ $item['attr_id'] }}">
                                                    @foreach ($item['value'] as $m => $value_name)
                                                        <a class="attr_val_name size_btn not_111 @if ($m === 0) selected_btn @endif"
                                                            color="not" id="attr_val_variant_id_{{ $item['id'][$m] }}"
                                                            data-name="{{ $item['name'] }}"
                                                            data-value-key="{{ $item['attr_id'] }}"
                                    ...
                                    @if (count($variant_images) > 0)
                                        <div
                                            class="single_details_content variant_image d-flex flex-wrap align-items-center mb-2 mb-md-3">
                                            ...
                                            @if (count($variant_images) > 5)
                                                <div class="variant-slider owl-carousel">
                                                    @foreach ($variant_images as $variant_key => $variant_image)
                                                        <div class="sku_img_div @if ($loop->first) active @endif "
                                                            id="{{ $variant_skus[$variant_key] }}"
                                                            data-id="{{ $variant_product_sku_ids[$variant_key] }}"
                                                            onclick="changeProdDetailsByVariantImg(this)">
                                                            <img src="{{ showImage($variant_image) }}"
                                                                title="{{ $variant_skus[$variant_key] }}"
                                                                class="img-fluid p-1 var_img_sources "
                                                                alt="{{ $variant_skus[$variant_key] }}"
                                                                data-id="{{ $variant_skus[$variant_key] }}" />
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @else
                                ...
                                @if (isModuleActive('WholeSale'))
                                    <div
                                        class="{{ @$product->skus->where('status', 1)->first()->wholeSalePrices->count() ? 'd-flex' : 'd-none' }}">
                                        <table class="table-sm append_w_s_p_tbl mb-3" width="100%">
                                            <thead>
                                                <tr class="border-bottom ">
                                                    <td class="text-left">
                                                        <label for=""
                                                            class="control-label">{{ __('common.Min QTY') }}</label>
                                                    </td>
                                                    <td class="text-left">
                                                        <label for=""
                                                            class="control-label">{{ __('common.Max QTY') }}</label>
                                                    </td>
                                                    <td class="text-left">
                                                        <label for=""
                                                            class="control-label">{{ __('common.unit_price') }}</label>
                                                    </td>
                                                </tr>
                                            </thead>
                                ...
                                <div class="product_info">
                                    <div class="single_pro_varient">
                                        ...
                                        <div class="product_number_count mr_5" data-target="amount-1">
                                            <span class="count_single_item inumber_decrement qtyChange" data-value="-"> <i
                                                    class="ti-minus"></i></span>
                                            <input name="qty" id="qty"
                                                class="count_single_item input-number qty" type="text"
                                                data-value="{{ @$product->product->minimum_order_qty }}"
                                                value="{{ getNumberTranslate(@$product->product->minimum_order_qty) }}">
                                            <span class="count_single_item number_increment qtyChange" data-value="+"> <i
                                                    class="ti-plus"></i></span>
                                        </div>
                                    </div>
                                    <input type="hidden" name="base_sku_price" id="base_sku_price"
                                        value="
                                        @if (@$product->hasDeal) {{ selling_price(@$product->skus->where('status', 1)->first()->sell_price, @$product->hasDeal->discount_type, @$product->hasDeal->discount) }}
                                        @else
                                            @if ($product->hasDiscount == 'yes')
                                            {{ selling_price(@$product->skus->where('status', 1)->first()->sell_price, @$product->discount_type, @$product->discount) }}
                                            @else
                                                {{ @$product->skus->where('status', 1)->first()->sell_price }} @endif
                                        @endif
                                    ">
                                        ...
                                        <div class="row mt_30 form-inline" id="checkpincode_div">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group ">
                                                    <input type="text" class="form-control" id="check_pincode"
                                                        placeholder="CHECK PINCODE"
                                                        style="border: none;border-bottom: 1px solid #ced4da;border-radius:0px;padding-top:20px; text-align:center;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mt-3 mt-md-0">
                                                <button type="button" class="amaz_primary_btn3"
                                                    id="check_pincode_btn">{{ __('checkpincode.check') }}</button>
                                            </div>
                                        </div>
                                        <div class="row d-none mt_10 availablity_show_div">
                                            <div class="col-lg-12">
                                                <p>{{ __('checkpincode.available_at') }} <span
                                                        id="pin_code_area"></span>.</p>

                                                <p class="pdelivery d-none">{{ __('amazy.Delivery within') }}: <span
                                                        id="pin_code_delivery"></span>.</p>
                                    ...
                                    @if (isGuestAddtoCart() == true)
                                            ...
                                            @if (
                                                ...
                                                <div class="col-12">
                                                    <button type="button" id="add_to_cart_btn"
                                                        class="amaz_primary_btn style2 mb_20  add_to_cart add_to_cart_btn text-uppercase flex-fill text-center w-100">{{ __('common.add_to_cart') }}</button>
                                                </div>
                                                <div class="col-6">
                                                    <button type="button" id="butItNow"
                                                        class="amaz_primary_btn3 mb_20  w-100 text-center justify-content-center text-uppercase buy_now_btn"
                                                        data-id="{{ $product->id }}"
                                                        data-type="product">{{ __('common.buy_now') }}</button>
                                                </div>
                                            @elseif($product->stock_manage == 0)
                                                <div class="col-12">
                                                    <button type="button" id="add_to_cart_btn"
                                                        class="amaz_primary_btn style2 mb_20  add_to_cart text-uppercase add_to_cart_btn flex-fill text-center w-100">{{ __('common.add_to_cart') }}</button>
                                                </div>
                                                <div class="col-6">
                                                    <button type="button" id="butItNow"
                                                        class="amaz_primary_btn3 mb_20  w-100 text-center justify-content-center text-uppercase buy_now_btn"
                                            ...
                                            @else
                                                <div class="col-6">
                                                    <button type="button" disabled
                                                        class="amaz_primary_btn style2 mb_20  add_to_cart text-uppercase flex-fill text-center w-100">{{ __('defaultTheme.out_of_stock') }}</button>
                                                </div>
                                            @endif
                                            @if (!Auth::check())
                                                <div class="col-6">
                                                    <a href="{{ route('login') }}"
                                                        class="amaz_primary_btn style2 mb_20  add_to_cart text-uppercase flex-fill text-center w-100">Chat
                                                        Inqiury</a>
                                                </div>
                                            @else
                                                <div class="col-6">
                                                    <a href="{{ route('frontend.chat.conversation', [$product->user_id, $product->id]) }}"
                                                        class="amaz_primary_btn style2 mb_20  add_to_cart text-uppercase flex-fill text-center w-100">Chat
                                                        Inqiury</a>
                                                </div>
                                            @endif
                                        ...
                                        <div class="add_wish_compare d-flex alingn-items-center mb_20">
                                            <a id="wishlist_btn" data-product_id="{{ $product->id }}"
                                                data-seller_id="{{ $product->user_id }}"
                                                class="single_wish_compare text-uppercase text-nowrap cursor_pointer">
                                                <i class="far fa-heart"></i> {{ __('defaultTheme.add_to_wishlist') }}
                                            </a>
                                            <a id="add_to_compare_btn_modify" data-product_sku_id="#product_sku_id"
                                                data-product_type="{{ $product->product->product_type }}"
                                                class="single_wish_compare text-uppercase text-nowrap cursor_pointer">
                                                <i class="ti-control-shuffle"></i>
                                                {{ __('defaultTheme.add_to_compare') }}
                                            </a>
                                            @if (!empty($product->seller) && $product->seller->role_id != 1 && app('general_setting')->product_report == 1)

                                                <a class="report-product" data-product-id='{{ $product->product_id }}'
                            ...
                            @if (
                                ($product->stock_manage == 1 &&
                                    $product->skus->where('status', 1)->first()->product_stock >= $product->product->minimum_order_qty) ||
                                    $product->stock_manage == 0)
                                @if (
                                    ($both_buy_product &&
                                        $both_buy_product->stock_manage == 1 &&
                                        $both_buy_product->skus->first()->product_stock >= $both_buy_product->product->minimum_order_qty) ||
                                        ($both_buy_product && $both_buy_product->stock_manage == 0))
                                    <div class="product_details_sujjetion">
                                        <h4 class="font_14 f_w_700 text-uppercase mb_12 lh-1">
                                            {{ __('amazy.YOU CAN ALSO BUY') }}:</h4>
                                        <div class="product_details_sujjetion_box">
                                            <a href="{{ singleProductURL(@$both_buy_product->seller->slug, $both_buy_product->slug) }}"
                                                class="product_details_sujjetion_single d-flex align-items-center gap_15">
                                                @php
                                                    if (@$product->hasDeal) {
                                                        $both_buy_price = selling_price(
                                                            @$both_buy_product->skus->first()->sell_price,
                                                            @$both_buy_product->hasDeal->discount_type,
                                                            @$both_buy_product->hasDeal->discount,
                                                        );
                                                    } else {
                                                        if (@$product->hasDiscount == 'yes') {
                                                            $both_buy_price = selling_price(
                                                                @$both_buy_product->skus->first()->sell_price,
                                                                @$both_buy_product->discount_type,
                                                                @$both_buy_product->discount,
                                                            );
                                                        } else {
                                                            $both_buy_price = @$both_buy_product->skus->first()
                                                                ->sell_price;
                                                        }
                                                    }
                                                @endphp
                                                <input type="hidden" id="both_buy_price"
                                                    value="{{ $both_buy_price }}">
                                                <div class="thumb both_buy">
                                                    <img src="
                                                @if (@$both_buy_product->thum_img != null) {{ showImage(@$both_buy_product->thum_img) }}
                                                @else
                                                    {{ showImage(@$both_buy_product->product->thumbnail_image_source) }} @endif
                                                "
                                                        alt="{{ @$both_buy_product->product->product_name }}"
                                                        title="{{ @$both_buy_product->product->product_name }}">
                                                </div>
                                                <div class="product_details_sujjetion_content">
                                                    <h4 class="fs-6 f_w_700">
                                                        @if ($both_buy_product->product_name)
                                                            {{ textLimit($both_buy_product->product_name, 28) }}
                                                        @else
                                                            {{ textLimit(@$both_buy_product->product->product_name, 28) }}
                                                        @endif
                                                    </h4>
                                            ...
                                            <div class="product_details_sujjetion_total d-flex align-items-center gap_15">
                                                <div class="product_details_sujjetion_left flex-fill">
                                                    <span
                                                        class="font_12 f_w_500 d-block">{{ __('common.total_price') }}:</span>
                                                    <h4 id="both_buy_price_show" class="font_16 f_w_700 m-0 lh-1"></h4>
                                                </div>
                                                <a href="#" class="amaz_primary_btn style3 text-uppercase"
                                                    id="both_buy_btn"
                                                    data-sku_id="{{ @$both_buy_product->skus->first()->id }}"
                                                    data-seller_id="{{ $both_buy_product->user_id }}"
                                                    data-product_id="{{ $both_buy_product->id }}"
                                                    data-qty="{{ @$both_buy_product->product->minimum_order_qty }}">{{ __('amazy.Buy Both') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="contact_wiz_box mt_20">
                                ...
                                <span
                                    class="contact_box_title font_16 f_w_500 d-block lh-1 ">{{ __('defaultTheme.share_on') }}:</span>
                        ...
                        <div class="col-12">
                            <div class="product_details_dec mb_76">
                                ...
                                <div class="product_details_dec_body">
                                    ...
                                    <div class="col-12 show_full_btn d-none">
                                        <button id="show_full_details"
                                            class="show_less amaz_primary_btn style3 text-uppercase">Show More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="product_details_dec mb_76">
                                ...
                                <div class="product_details_dec_body">
                                    <div class="single_desc style2 mb_20">
                                        <p class="f_w_500 m-0">{{ __('common.brand') }}:
                                            {{ @$product->product->brand->name }}</p>
                                        <p class="f_w_500 m-0">{{ __('common.model_number') }}:
                                            {{ @$product->product->model_number }}</p>
                                        ...
                                        <p class="f_w_500 m-0">{{ __('common.minimum_order_quantity') }}:
                                            {{ getNumberTranslate(@$product->product->minimum_order_qty) }}</p>
                                        <p class="f_w_500 m-0">{{ __('common.maximum_order_quantity') }}:
                                            {{ getNumberTranslate(@$product->product->max_order_qty) }}</p>
                                        <p class="f_w_500 m-0">{{ __('common.listed_date') }}:
                                            {{ dateConvert(@$product->product->created_at) }}</p>
                                    </div>
                                    @php
                            ...
                            @if (!empty($product->product->pdf))
                                <div class="product_details_dec mb_76">
                                    ...
                                    <div class="product_details_dec_body">
                                        <a class="anchore_color" href="{{ asset(asset_path($product->product->pdf)) }}"
                                            download>{{ __('product.download_file') }}</a>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="product_details_dec_body">
                                        <div class="product_details">
                                            @if ($product->product->video_provider == 'youtube')
                                                ...
                                                @endphp
                                                <iframe src="{{ $link }}" title="YouTube video player"
                                                    frameborder="0"
                                            ...
                                            @if ($product->product->video_provider == 'daily_motion')
                                                ...
                                                <div
                                                    ...
                                                    <iframe
                                                        ...
                                                        frameborder="0" type="text/html" src="{{ $link }}"
                                    ...
                                    <div class="col-12">
                                        <div class="section__title d-flex align-items-center gap-3 mb_30">
                                            <h3 class="m-0 flex-fill">
                                                {{ __('amazy.Customers who viewed this also viewed') }}</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 d-flex">
                                            <div class="product_widget5 mb_30 style5 w-100">
                                                <div class="product_thumb_upper">
                                                    @php
                                                        ...
                                                        $showData = [
                                                            ...
                                                            'url' => singleProductURL(
                                                                @$recent_viewed_product->seller->slug,
                                                                @$recent_viewed_product->slug,
                                                            ),
                                                            'price' => $price_qty,
                                                            'thumbnail' => $thumbnail,
                                                        ];
                                                    ...
                                                    <a href="{{ singleProductURL($recent_viewed_product->seller->slug, $recent_viewed_product->slug) }}"
                                                        ...
                                                        @if (app('general_setting')->lazyload == 1)
                                                            <img data-src="{{ $thumbnail }}"
                                                                ...
                                                                alt="{{ @$recent_viewed_product->product_name }}"
                                                                title="{{ @$recent_viewed_product->product_name }}"
                                                                class="lazyload">
                                                        @else
                                                            <img src="{{ $thumbnail }}"
                                                                alt="{{ @$recent_viewed_product->product_name }}"
                                                    ...
                                                    @if (isGuestAddtoCart())
                                                        <div class="product_action">
                                                            <a href="" class="addToCompareFromThumnail"
                                                                data-producttype="{{ @$recent_viewed_product->product->product_type }}"
                                                                data-seller={{ $recent_viewed_product->user_id }}
                                                                data-product-sku={{ @$recent_viewed_product->skus->first()->id }}
                                                                data-product-id={{ $recent_viewed_product->id }}>
                                                                <i class="ti-control-shuffle"
                                                                    title="{{ __('defaultTheme.compare') }}"></i>
                                                            </a>
                                                            <a href=""
                                                                class="add_to_wishlist {{ $recent_viewed_product->is_wishlist() == 1 ? 'is_wishlist' : '' }}"
                                                                id="wishlistbtn_{{ $recent_viewed_product->id }}"
                                                                data-product_id="{{ $recent_viewed_product->id }}"
                                                                data-seller_id="{{ $recent_viewed_product->user_id }}">
                                                                <i class="far fa-heart"
                                                                    title="{{ __('defaultTheme.wishlist') }}"></i>
                                                            </a>
                                                            <a class="quickView"
                                                                data-product_id="{{ $recent_viewed_product->id }}"
                                                                data-type="product">
                                                                <i class="ti-eye"
                                                                    title="{{ __('defaultTheme.quick_view') }}"></i>
                                                            </a>
                                                        </div>
                                                    @endif
                                                    <div class="product_badge">
                                                                    ...
                                                                    <span class="d-flex align-items-center discount">
                                                                        @if ($recent_viewed_product->hasDeal->discount > 0)
                                                                            @if ($recent_viewed_product->hasDeal->discount_type == 0)
                                                                                {{ getNumberTranslate($recent_viewed_product->hasDeal->discount) }}
                                                                                % {{ __('common.off') }}
                                                                            @else
                                                                                {{ single_price($recent_viewed_product->hasDeal->discount) }}
                                                                                {{ __('common.off') }}
                                                                            @endif
                                                                        ...
                                                                        <span class="d-flex align-items-center discount">
                                                                            @if ($recent_viewed_product->discount > 0)
                                                                                @if ($recent_viewed_product->discount_type == 0)
                                                                                    {{ getNumberTranslate($recent_viewed_product->discount) }}
                                                                                    % {{ __('common.off') }}
                                                                                @else
                                                                                    {{ single_price($recent_viewed_product->discount) }}
                                                                                    {{ __('common.off') }}
                                                                                @endif
                                                                            @endif
                                                                        </span>
                                                        ...
                                                        @if (isModuleActive('WholeSale') && @$recent_viewed_product->skus->first()->wholeSalePrices->count())
                                                            <span
                                                                class="d-flex align-items-center sale">{{ __('common.wholesale') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="product_star mx-auto">
                                                    @php
                                                        $reviews = @$recent_viewed_product->reviews
                                                            ->where('status', 1)
                                                            ->pluck('rating');
                                                ...
                                                <div class="product__meta text-center">
                                                    <span
                                                        class="product_banding ">{{ @$recent_viewed_product->brand->name ?? ' ' }}</span>
                                                    <a
                                                        href="{{ singleProductURL(@$recent_viewed_product->seller->slug, $recent_viewed_product->slug) }}">
                                                        <h4>
                                                            @if ($recent_viewed_product->product_name)
                                                                {{ textLimit(@$recent_viewed_product->product_name, 50) }}
                                                            @else
                                                                {{ textLimit(@$recent_viewed_product->product->product_name, 50) }}
                                                            @endif
                                                        </h4>
                                                    </a>
                                                    ...
                                                    @if (isGuestAddtoCart())
                                                        <div
                                                            class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                            <a class="amaz_primary_btn addToCartFromThumnail"
                                                                data-producttype="{{ @$recent_viewed_product->product->product_type }}"
                                                                data-seller={{ $recent_viewed_product->user_id }}
                                                                data-product-sku={{ @$recent_viewed_product->skus->first()->id }}
                                                                @if (@$recent_viewed_product->hasDeal) data-base-price={{ selling_price(@$recent_viewed_product->skus->first()->sell_price, @$recent_viewed_product->hasDeal->discount_type, @$recent_viewed_product->hasDeal->discount) }}
                                                                    @else
                                                                        @if (@$recent_viewed_product->hasDiscount == 'yes')
                                                                        ...
                                                                        @else
                                                                            data-base-price={{ @$recent_viewed_product->skus->first()->sell_price }} @endif
                                                                @endif
                                                    ...
                                                    @else
                                                        <div
                                                            class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                            <a class="amaz_primary_btn w-100" style="text-indent: 0;"
                                                                href="{{ url('/login') }}">
                        ...
                        <div class="col-12" id="Reviews">
                            @include(theme('partials._product_review_with_paginate'), [
                                'reviews' => @$product->ActiveReviewsWithPaginate,
                ...
                <div class="col-xl-3">
                    @php
                        $free_shipping = \Modules\Shipping\Entities\ShippingMethod::where(
                            'request_by_user',
                            $product->user_id,
                        )
                            ->where('is_active', 1)
                    ...
                    @if ($free_shipping)
                        <div class="amazcart_delivery_wiz mb_20">
                            ...
                            <div class="amazcart_delivery_wiz_body">
                                ...
                                <p class="delivery_text font_14 f_w_400">{{ __('common.free_shipping_on') }}
                                    {{ $free_shipping->method_name }} {{ __('common.starts from order amount') }}
                                    {{ single_price($free_shipping->minimum_shopping) }}</p>
                            </div>
                        </div>
                    @endif
                    <div class="amazcart_delivery_wiz mb_20">
                        ...
                        <div class="amazcart_delivery_wiz_body">
                            <div class="loc_city_selectBox d-flex flex-column">
                                <div class="selectBox_box ">
                                    @php
                                        if (@$product->seller->role_id == 1) {
                                            ...
                                            $country_id = @$product->seller->SellerBusinessInformation
                                                ->business_country;
                                    ...
                                    <select class="amaz_select2 mb_10 w-100" id="select_city" name="select_city">
                                        <option data-display="Choose City" selected disabled>
                                            {{ __('common.choose_city') }}</option>
                                        @if ($country)
                                            @foreach ($country->cities as $city)
                                                <option value="{{ $city->id }}"
                                                    {{ $city->id == $city_id ? 'selected' : '' }}>{{ $city->name }}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="selectBox_box">
                                    @php
                                        $pickup_locations = \Modules\Shipping\Entities\PickupLocation::where(
                                            'created_by',
                                            $product->user_id,
                                        )
                                            ->where('status', 1)
                                    ...
                                    <select class="amaz_select2 w-100" id="selectPickup">
                                        <option data-display="Choose pickup location" disabled>
                                            {{ __('amazy.Choose pickup location') }}</option>
                                        @if ($pickup_locations)
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 mb_10">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{ url('/') }}/frontend/amazy/img/product_details/details_car.svg"
                                        alt="{{ __('amazy.Door Delivery') }}" title="{{ __('amazy.Door Delivery') }}">
                                </div>
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 ">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{ url('/') }}/frontend/amazy/img/product_details/details_pickup.svg"
                                        alt="{{ __('amazy.Pickup Location') }}"
                                        title="{{ __('amazy.Pickup Location') }}">
                                </div>
                                <div class="amazcart_delivery_wiz_content">
                    ...
                    <div class="amazcart_delivery_wiz mb_20">
                        <div class="amazcart_delivery_wiz_body">
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 mb_10">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{ url('/') }}/frontend/amazy/img/product_details/details_pickup.svg"
                                        alt="{{ __('amazy.Return Policy') }}" title="{{ __('amazy.Return Policy') }}">
                                </div>
                                <div class="amazcart_delivery_wiz_content">
                                    <h4 class="font_16 f_w_700 mb_6">{{ __('amazy.Return Policy') }}</h4>
                                    <p class="delivery_text font_14 f_w_400">
                                        {{ __('amazy.Easy Return, Quick Refund.') }} <a class="text-nowrap"
                                            href="{{ url('/return-exchange') }}">{{ __('common.see_more') }}.</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="amazcart_delivery_wiz mb_30">
                            ...
                            <div class="amazcart_delivery_wiz_body">
                                <h4 class="font_14 f_w_700 mb-0">
                                    <a id="shopLink"
                                        href="
                                        @if ($product->seller->slug) {{ route('frontend.seller', $product->seller->slug) }}
                                        @else
                                            {{ route('frontend.seller', base64_encode($product->seller->id)) }} @endif
                                    ">
                                ...
                                @php
                                    $seller_rating_avg = $product->seller
                                        ->sellerReviews()
                                        ->where('status', 1)
                                        ->avg('rating');
                                ...
                                <div class="Information_box d-flex gap-2 flex-wrap ">
                                    <div class="Information_box_left flex-fill">
                                        ...
                                        <div class="single_info_seller d-flex align-items-center gap_15">
                                            <h4 class="font_14 f_w_500 m-0" id="follow_seller_count">
                                                {{ getNumberTranslate($product->seller->countFollow()) }}</h4>
                                    ...
                                    <div class="Information_box_right">
                                        @if (auth()->check() && auth()->id() != $product->seller->id)
                                            @if (auth()->check() &&
                                                    !auth()->user()->follow($product->seller->id))
                                        ...
                                        @elseif(!auth()->check())
                                            <a href="{{ url('/login') }}"
                                                class="amaz_primary_btn style3 text-uppercase">{{ __('common.follow') }}</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="seller_performance_box">
                                    ...
                                    @foreach ($product->seller->sellerReviews->where('status', 1) as $seller_review)
                                        <div class="single_seller_performance d-flex align-items-center gap_10 mb-1">
                                            <img src="{{ showImage('frontend/amazy/img/product_details/star.svg') }}"
                                                alt="{{ @$product->seller->SellerAccount->seller_shop_display_name }}"
                                                title="{{ @$product->seller->SellerAccount->seller_shop_display_name }}">
                                ...
                                <div class="product_widget5 mb_30 style5 w-100">
                                    <div class="product_thumb_upper">
                                        @php
                                            if (@$related_seller_product->thum_img != null) {
                                                ...
                                                $thumbnail = showImage(
                                                    @$related_seller_product->product->thumbnail_image_source,
                                                );
                                            }
                                            ...
                                            $showData = [
                                                ...
                                                'url' => singleProductURL(
                                                    @$related_seller_product->seller->slug,
                                                    @$related_seller_product->slug,
                                                ),
                                                'price' => $price_qty,
                                                'thumbnail' => $thumbnail,
                                            ];
                                        ...
                                        <a href="{{ singleProductURL(@$related_seller_product->seller->slug, $related_seller_product->slug) }}"
                                            ...
                                            @if (app('general_setting')->lazyload == 1)
                                                <img data-src="{{ $thumbnail }}"
                                                    src="{{ showImage(themeDefaultImg()) }}"alt="{{ @$related_seller_product->product_name }}"
                                                    title="{{ @$related_seller_product->product_name }}"
                                                    class="lazyload">
                                            @else
                                                <img src="{{ $thumbnail }}"
                                                    alt="{{ @$related_seller_product->product_name }}"
                                                    title="{{ @$related_seller_product->product_name }}">
                                            @endif
                                        </a>
                                        @if (isGuestAddtoCart())
                                            <div class="product_action">
                                                <a href="" class="addToCompareFromThumnail"
                                                    data-producttype="{{ @$related_seller_product->product->product_type }}"
                                                    data-seller={{ $related_seller_product->user_id }}
                                                    data-product-sku={{ @$related_seller_product->skus->first()->id }}
                                                    data-product-id={{ $related_seller_product->id }}>
                                                    <i class="ti-control-shuffle"
                                                        title="{{ __('defaultTheme.compare') }}"></i>
                                                </a>
                                                <a href=""
                                                    class="add_to_wishlist {{ $related_seller_product->is_wishlist() == 1 ? 'is_wishlist' : '' }}"
                                                    id="wishlistbtn_{{ $related_seller_product->id }}"
                                                    data-product_id="{{ $related_seller_product->id }}"
                                                    data-seller_id="{{ $related_seller_product->user_id }}">
                                                    <i class="ti-heart" title="{{ __('defaultTheme.wishlist') }}"></i>
                                                </a>
                                                <a class="quickView" data-product_id="{{ $related_seller_product->id }}"
                                                    data-type="product">
                                                    ...
                                                    @if ($related_seller_product->hasDeal->discount > 0)
                                                        <span class="d-flex align-items-center discount">
                                                            @if ($related_seller_product->hasDeal->discount_type == 0)
                                                                {{ getNumberTranslate($related_seller_product->hasDeal->discount) }}
                                                                % {{ __('common.off') }}
                                                            @else
                                                                {{ single_price($related_seller_product->hasDeal->discount) }}
                                                                {{ __('common.off') }}
                                                            @endif
                                                        </span>
                                                    @endif
                                                        ...
                                                        @if ($related_seller_product->discount > 0)
                                                            <span class="d-flex align-items-center discount">
                                                                @if ($related_seller_product->discount_type == 0)
                                                                    {{ getNumberTranslate($related_seller_product->discount) }}
                                                                    % {{ __('common.off') }}
                                                                @else
                                                                    {{ single_price($related_seller_product->discount) }}
                                                                    {{ __('common.off') }}
                                                                @endif
                                                            </span>
                                                        @endif
                                    ...
                                    <div class="product_star mx-auto">
                                        @php
                                            ...
                                            $reviews = $related_seller_product->reviews
                                                ->where('status', 1)
                                                ->pluck('rating');
                                            if (count($reviews) > 0) {
                                                $value = 0;
                                    ...
                                    <div class="product__meta text-center">
                                        <span
                                            class="product_banding ">{{ @$related_seller_product->brand->name ?? ' ' }}</span>
                                        <a
                                            href="{{ singleProductURL(@$related_seller_product->seller->slug, $related_seller_product->slug) }}">
                                            <h4>
                                                @if ($related_seller_product->product_name)
                                                    {{ textLimit(@$related_seller_product->product_name, 50) }}
                                                @else
                                                    {{ textLimit(@$related_seller_product->product->product_name, 50) }}
                                                @endif
                                            </h4>
                                        </a>
                                        ...
                                        @if (isGuestAddtoCart())
                                            <div
                                                class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                <a class="amaz_primary_btn add_cart add_to_cart addToCartFromThumnail"
                                                    data-producttype="{{ @$related_seller_product->product->product_type }}"
                                                    data-seller={{ $related_seller_product->user_id }}
                                                    data-product-sku={{ @$related_seller_product->skus->first()->id }}
                                                    @if (@$related_seller_product->hasDeal) data-base-price={{ selling_price(@$related_seller_product->skus->first()->sell_price, @$related_seller_product->hasDeal->discount_type, @$related_seller_product->hasDeal->discount) }}
                                                @else
                                                    @if (@$related_seller_product->hasDiscount == 'yes')
                                                    ...
                                                    @else
                                                        data-base-price={{ @$related_seller_product->skus->first()->sell_price }} @endif
                                                    @endif
                                                    data-shipping-method=0
                                                    data-product-id={{ $related_seller_product->id }}
                                        ...
                                        @else
                                            <div
                                                class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                <a class="amaz_primary_btn add_cart w-100 " style="text-indent: 0;"
                                                    href="{{ url('/login') }}">
                                                    {{ __('defaultTheme.login_to_order') }}
                                                </a>
                                            </div>
    ...
    @if (isModuleActive('WholeSale'))
        <input type="hidden" id="getWholesalePrice"
            value="@if (@$product->skus->where('status', 1)->first()->wholeSalePrices->count()) {{ json_encode(@$product->skus->where('status', 1)->first()->wholeSalePrices) }} @else 0 @endif">
    @endif
...
@push('scripts')
            ...
            $(document).ready(function() {
                ...
                @if (isModuleActive('CheckPincode'))
                    $('#check_pincode_btn').click(function(e) {
                        ...
                        $.post("{{ route('checkpincode.pin.code.availablity') }}", data, function(
                            response) {
                            if (response.data != null) {
                                $('.not_serve').addClass('d-none');
                                $('.availablity_show_div').removeClass('d-none');
                                $('#pin_code_area').text(response.data.city + ", " + response
                                    .data.state);
                                $('#pin_code_delivery').text(response.data.delivery_days +
                                    " days");
                ...
                function fetch_data(page) {
                    $('#pre-loader').show();
                    var url = "{{ route('frontend.product.reviews.get-data') }}" + '?product_id=' +
                ...
                $(document).on('click', '.attr_val_name', function() {
                    $(this).parent().parent().find('.attr_value_name').val($(this).attr('data-value') +
                        '-' + $(this).attr('data-value-key'));
                    $(this).parent().parent().find('.attr_value_id').val($(this).attr('data-value') +
                        '-' + $(this).attr('data-value-key'));
                ...
                $(document).on('click', '.add_to_cart_btn', function(event) {
                    ...
                    addToCart($('#product_sku_id').val(), $('#seller_id').val(), $('#qty').data(
                        'value'), $('#base_sku_price').val().trim(), $('#shipping_type').val(),
                        'product', showData);
                });
                $(document).on('click', '#both_buy_btn', function(event) {
                    ...
                    addToCart(product_sku_id, seller_id, qty, $('#both_buy_price').val(), '0',
                        'product');
                    addToCart($('#product_sku_id').val(), $('#seller_id').val(), $('#qty').data(
                        'value'), $('#base_sku_price').val().trim(), $('#shipping_type').val(),
                        'product');
                ...
                $(document).on('click', '#wishlist_btn', function(event) {
                    ...
                    if (is_login == 1) {
                        ...
                        toastr.warning("{{ __('defaultTheme.please_login_first') }}",
                            "{{ __('common.warning') }}");
                    }
                });
                    ...
                    if (stock_manage_status != 0) {
                        if (parseInt(qty) < parseInt(available_stock)) {
                            if (maximum_order_qty != '' && maximum_order_qty != '') {
                                if (parseInt(qty) >= 1) {
                                    if (parseInt(qty) > parseInt(maximum_order_qty) && parseInt(qty) >
                                        parseInt(minimum_order_qty)) {
                                        toastr.warning(
                                            '{{ __('defaultTheme.maximum_quantity_limit_is') }}' +
                                            maximum_order_qty + '.', '{{ __('common.warning') }}');
                                    } else if (parseInt(qty) < parseInt(maximum_order_qty) && parseInt(
                                            qty) < parseInt(minimum_order_qty)) {
                                        toastr.warning(
                                            '{{ __('defaultTheme.minimum_quantity_Limit_is') }}' +
                                            minimum_order_qty + '.', '{{ __('common.warning') }}');
                                    } else {
                            ...
                            if (parseInt(qty) >= 0) {
                                toastr.error("{{ __('defaultTheme.no_more_stock') }}",
                                    "{{ __('common.error') }}");
                            }
                            return false;
                        }
                        ...
                        if (maximum_order_qty != '' && minimum_order_qty != '') {
                            ...
                            if (parseInt(qty) >= 1) {
                                ...
                                toastr.warning('{{ __('defaultTheme.minimum_quantity_Limit_is') }}' +
                                    minimum_order_qty + '.', '{{ __('common.warning') }}');
                            }
                        }
                    }
                            ...
                            if (parseInt(qty) < parseInt(available_stock)) {
                                if (maximum_order_qty != '') {
                                    if (parseInt(qty) < parseInt(maximum_order_qty)) {
                                        ...
                                        toastr.warning('{{ __('defaultTheme.maximum_quantity_limit_is') }}' +
                                            maximum_order_qty + '.', '{{ __('common.warning') }}');
                                    }
                                } else {
                                    let qty1 = parseInt(++qty);
                ...
                function get_price_accordint_to_sku() {
                    var value = $("input[name='attr_val_name[]']").map(function() {
                        return $(this).val();
                    }).get();
                    var id = $("input[name='attr_val_id[]']").map(function() {
                        return $(this).val();
                    }).get();
                    var product_id = $("#product_id").val();
                    var user_id = $('#seller_id').val();
                    $('#pre-loader').show();
                    $.post("{{ route('seller.get_seller_product_sku_wise_price') }}", {
                        _token: '{{ csrf_token() }}',
                        id: id,
                        ...
                        if (response != 0) {
                            ...
                            $(response.data.product.variantDetails).each(function(key, index) {
                                if (response.data.product.variantDetails.length > 1) {
                                    $.each(color, function(i, v) {
                                        ...
                                        if (isLastElement) {
                                            $('#color_name').text(index.name + ': ' +
                                            v);
                                        } else {
                                            $('#size_name' + key).text(index.name +
                                                ': ' + color[key + 1]);
                                        }
                                    });
                                    changeTabbyAmount();
                            ...
                            if (response.data.product.stock_manage == 1 && parseInt(response.data
                                    .product_stock) >= parseInt(response.data.product.product
                                    .minimum_order_qty) || response.data.product.stock_manage == 0) {
                                @if (isGuestAddtoCart())
                                ...
                                @endif
                                $('#stock_div').html(
                                    `<span class="stokeout_badge">{{ __('defaultTheme.out_of_stock') }}</span>`
                                    );
                            ...
                            toastr.error("{{ __('defaultTheme.no_stock_found_for_this_seller') }}",
                                "{{ __('common.error') }}");
                        }
                        $('#pre-loader').hide();
                    });
                ...
                $(document).on('change', '#select_city', function(event) {
                    ...
                    $('#pre-loader').show();
                    $.post("{{ route('frontend.item.get_pickup_by_city') }}", data, function(
                    response) {
                        $('#selectPickup').empty();
                        $('#selectPickup').append(
                        ...
                        $.each(response, function(index, pickup) {
                            $('#selectPickup').append('<option value="' + pickup.id +
                ...
                $(document).on("click", ".buy_now_btn", function(event) {
                    event.preventDefault();
                    buyNow($('#product_sku_id').val(), $('#seller_id').val(), $('#qty').data('value'),
                        $('#base_sku_price').val().trim(), $('#shipping_type').val(), 'product', $(
                            '#owner').val());
                });
    ...
    <script>
        ...
        function changeProdDetailsByVariantImg(element) {
            ...
            $.post("{{ route('seller.get_seller_product_variant_wise_price') }}", {
                _token: '{{ csrf_token() }}',
                id: id,
                product_id: product_id,
                user_id: user_id
                ...
                if (response != 0) {
                        ...
                        if (response.data.product_sku_id == index.product_sku_id) {
                            $(index.product_variations).each(function(key2, index2) {
                                if (index2.attribute.name == 'Shoe Size') {
                                    ...
                                    $('#attr_val_variant_id_' + index2.attribute_value.id).addClass(
                                        'selected_btn');
                                }
                                if (index2.attribute.name == 'Color') {
                                    ...
                                    $('.radio_' + index2.attribute_value.id).attr('checked',
                                        'checked');
                                }
                    ...
                    if (response.data.product.stock_manage == 1 && parseInt(response.data.product_stock) >=
                        parseInt(response.data.product.product.minimum_order_qty) || response.data.product
                        .stock_manage == 0) {
                        @if (isGuestAddtoCart())
                            $('#add_to_cart_div').html(`
                                    <div class="col-md-6">
