<head>
    ...
    <!-- CSS here -->
    @if(isRtl())
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/bootstrap.rtl.min.css">
    @else
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/bootstrap.min.css">
    @endif
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/magnific-popup.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/fontawesome.css ">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/themify-icons.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/flaticon.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/nice-select2.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/gijgo.min.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/perfect-scrollbar.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/jquery-ui.css ">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/animate.min.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/slick.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/slicknav.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/swiper-bundle.min.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/summernote-lite.css">
    <link rel="stylesheet" href="{{ asset(asset_path('backend/vendors/css/toastr.min.css')) }}" />
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/style.css">
    <link rel="stylesheet" href="{{url('/')}}/backend/css/preloader.css">
    <link rel="stylesheet" href="{{url('/')}}/frontend/amazy/css/extra_style.css">
