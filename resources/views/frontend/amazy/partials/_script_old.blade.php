...
<script src="{{url('/')}}/frontend/amazy/js/vendor/popper.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/vendor/bootstrap.min.js"></script>

<script src="{{url('/')}}/frontend/amazy/js/owl.carousel.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/swiper-bundle.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/isotope.pkgd.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/waypoints.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/jquery.counterup.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/imagesloaded.pkgd.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/wow.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/nice-select.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/barfiller.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/jquery.slicknav.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/jquery.magnific-popup.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/jquery.ajaxchimp.min.js"></script>
<script src="{{url('/')}}/frontend/amazy/js/parallax.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/gijgo.min.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/slick.min.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/eleveti_zoom.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/perfect-scrollbar.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/jquery.nav.js"></script>
 <script src="{{url('/')}}/frontend/amazy/js/summernote-lite.min.js"></script>

 @if(url()->current() != url('/profile'))
    <script src="{{url('/')}}/frontend/amazy/js/query-ui.js"></script>
@endif

<script src="{{url('/')}}/frontend/amazy/js/jquery.countdown.min.js"></script>
<script type="text/javascript" src="{{asset(asset_path('backend/vendors/js/toastr.min.js'))}}"></script>
<script src="{{url('/')}}/frontend/amazy/js/mail-script.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDfpGBFn5yRPvJrvAKoGIdj1O1aO9QisgQ"></script>
<script src="{{url('/')}}/frontend/amazy/js/map.js"></script>
<!-- MAIN JS   -->
<script src="{{url('/')}}/frontend/amazy/js/main.js"></script>
<script src="{{url('/')}}/frontend/default/js/highlight.js"></script>
<script src="{{url('/')}}/backend/vendors/lazyload/lazyload.js"></script>
