                    ...
                    <div class="billing_address">
                        ...
                        <div class="row shipping_address_edit_div {{$shipping_address?'d-none':""}}">
                            ...
                            <div class="col-lg-6 mb_20">
                                ...
                                <input class="primary_input3 style5 radius_3px" type="text" name="phone" data-min="{{  app('general_setting')->min_digit }}" data-max="{{  app('general_setting')->max_digit }}" value="{{$shipping_address?$shipping_address->phone:$user_phone}}" id="phone" placeholder="{{__('common.phone')}}">
