                ...
                <div class="product_details">
                    ...
                    <div class="single_details_content social_icon d-flex">
                        ...
                        <div class="social_icon_iner">
                            ...
                            @endphp
                            <a href="{{ $sharelinks['facebook'] }}"><i class="ti-facebook"></i></a>
                            <a href="{{ $sharelinks['twitter'] }}"><i class="ti-twitter-alt"></i></a>
                            <a href="{{ $sharelinks['linkedin'] }}"><i class="ti-linkedin"></i></a>
                            <a href="{{ $sharelinks['whatsapp'] }}"><i class="fab fa-whatsapp"></i></a>
                            <a href="{{ $sharelinks['telegram'] }}"><i class="fab fa-telegram-plane"></i></a>
                            <a href="{{ $sharelinks['reddit'] }}"><i class="ti-reddit"></i></a>
                        </div>
                    </div>
                </div>
            </div>
