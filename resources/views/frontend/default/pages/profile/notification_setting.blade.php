                                ...
                                <tr>
                                    <form action="{{route('frontend.notification_setting.update',$userNotificationSetting->id)}}"
                                        ...
                                        <td>
                                            ...
                                            type="checkbox">
                                            <span class="checkmark"></span> {{__('common.email')}} <br>
                                            @endif
                                            ...
                                            type="checkbox">
                                            <span class="checkmark"></span> {{__('common.mobile')}} <br>
                                            @endif
                                            ...
                                            type="checkbox">
                                            <span class="checkmark"></span> {{__('common.sms')}} <br>
                                            @endif
                                            ...
                                            type="checkbox">
                                            <span class="checkmark"></span> {{__('common.system')}} <br>
                                            @endif
