...
class SellerProduct extends Model
{
    ...
    public $translatable = [];
    protected $casts   = ['discount' =>'integer','product_id' => 'integer','min_sell_price' => 'double','max_sell_price' => 'double','total_sale' => 'integer', 'tax' => 'double','user_id' => 'integer','avg_rating' => 'integer','stock_manage' => 'integer','is_approved' => 'integer','status' => 'integer'];
