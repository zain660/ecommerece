        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                ...
                <div class="w-100 mt-3">
                    <a  class="remove-image primary-btn ml-2 fix-gr-bg {{ empty($promotionbar) || empty($promotionbar->image) ? 'd-none':'' }}" data-default-img='{{ asset("public/backend/img/default.png") }}' data-id='{{ $promotionbar->id }}' href="{{ route('frontendcms.promotionbar.removeImage') }}">Remove Image</a>
                </div>
            </div>
        </div>
