                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="primary_input mb-15">
                                <label class="primary_input_label">{{__('refund.refund_status') }}</label>
                                <label class="switch_toggle" for="checkbox{{ $approval->id }}">
                                    <input type="checkbox" id="checkbox{{ $approval->id }}" @if ($approval->status == 1) checked @endif value="{{ $approval->id }}" class="refund_status">
                    ...
                    <form action="{{ route('refund.refund_config_store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="status">{{__('refund.refund_time') }} {{__('refund.in_days') }} <span class="text-danger">*</span></label>
                                    <input class="primary_input_field" name="status" id="status" type="text" value="{{$refund_time->status}}" required="1">
