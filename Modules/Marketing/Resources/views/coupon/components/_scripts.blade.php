        ...
        $(document).ready(function(){
            ...
            $(document).on('change','#coupon_type', function(event){
                ...
                $.get(url, function(data) {
                    ...
                    dynamicSelect2WithAjax("#product_list", "{{url('/products/seller-products/get-by-ajax')}}", "GET");
            ...
            $(document).on('click', '#is_multiple', function(event){
                if ($(this).prop('checked')) {
                    $('.coupon_limit').removeClass('d-none');
                }else{
                    $('.coupon_limit').addClass('d-none');
                }
            });
            ...
            function showValidationErrors(formType, errors) {
                ...
                @if(isModuleActive('FrontendMultiLang'))
                    $(formType + ' #error_coupon_title_{{auth()->user()->lang_code}}').text(errors['coupon_title.{{auth()->user()->lang_code}}']);
                @else
            ...
            function removeValidateError(){
                ...
                $('#error_coupon_type').text('');
                @if(isModuleActive('FrontendMultiLang'))
                $('#error_coupon_title_{{auth()->user()->lang_code}}').text('');
                @else
