<div class="row">
    ...
    <div class="col-lg-12 coupon_limit d-none">
        <div class="primary_input mb-25">
            <label class="primary_input_label" for="multiple_buy_limit">{{__('marketing.multiple_buy_limit') }} </label>
            <input class="primary_input_field" name="multiple_buy_limit" id="multiple_buy_limit" placeholder="{{__('marketing.multiple_buy_limit') }}" type="text" value="{{old('multiple_buy_limit')}}">
