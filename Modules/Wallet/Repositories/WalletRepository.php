...
class WalletRepository
{
    ...
    public function entryAmountCreate($order_id, $total_amount, $type, $customer_id, $user_type)
    {
        WalletBalance::create([
            'walletable_id' => $order_id,
            'walletable_type' => 'Modules\AuctionProducts\Entities\AuctionEntryAmountPayment',
            'user_type' => $user_type,
            'user_id' => $customer_id,
            'type' => $type,
            'amount' => $total_amount,
