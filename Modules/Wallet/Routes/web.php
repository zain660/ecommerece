...
Route::prefix('wallet')->group(function() {
    Route::middleware(['auth','admin'])->group(function() {
        ...
        Route::get('/online-recharge-requests/get-data', 'WalletController@rechargeRequestGetData')->name('wallet_recharge.get-data');
        Route::get('/bank-recharge-requests', 'WalletController@BankRechargeIndex')->name('bank_recharge.index');
        Route::get('/bank-recharge-requests/get-data', 'WalletController@bankRechargeRequestGetData')->name('bank_recharge.get-data');
        Route::get('/recharge-offline-index', 'WalletController@offline_index')->name('wallet_recharge.offline_index');
        Route::get('/recharge-offline-index/get-data', 'WalletController@offline_index_get_data')->name('wallet_recharge.offline_index_get_data');
        ...
        if(isModuleActive('MultiVendor')){
            ...
            Route::get('/withdraw-requests/get-data', 'WithdrawRequestController@withdraw_requests_get_data')->name('wallet.withdraw_requests.get_data');
