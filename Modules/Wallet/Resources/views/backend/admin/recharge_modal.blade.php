                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="primary_input mb-25">
                                ...
                                @php
                                    $customer_role = \Modules\RolePermission\Entities\Role::where('type', 'customer')->first();
                                    $seller_role = \Modules\RolePermission\Entities\Role::where('type', 'seller')->first();
                                @endphp
                                <select class="primary_select mb-25" name="role_id" id="role_id">
                                    <option value="{{$customer_role->id}}">{{__('common.customer')}}</option>
                                    @if(isModuleActive('MultiVendor'))
                                    <option value="{{$seller_role->id}}">{{__('common.seller')}}</option>
                                    @endif
                                </select>
                        ...
                        <div class="col-xl-12">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="">{{ __('wallet.amount') }} ({{__('defaultTheme.currency')}} : {{app('general_setting')->currency_code}})<span class="text-danger"> *</span></label>
