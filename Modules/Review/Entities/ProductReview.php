...
{
    use HasFactory;
    protected $casts = ['customer_id' => 'integer','seller_id' => "integer",'product_id' => "integer",'order_id' => "integer",'rating' => 'integer','package_id' => 'integer','is_anonymous' => 'integer','status' => 'integer'];
    protected $guarded = [''];
