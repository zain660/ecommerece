...
class CreateNotificationSettingsTable extends Migration
{
    public function up()
    {
        ...
        $sql = [
            ...
            ['delivery_process_id' => null, 'event' => 'Withdraw request declined', 'type' => 'system', 'message' => 'Your withdraw request declined', 'user_access_status' => 0, 'seller_access_status' => 1, 'admin_access_status' => 1, 'staff_access_status' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['delivery_process_id' => null, 'event' => 'Withdraw request approve', 'type' => 'system', 'message' => 'Withdraw request approve','user_access_status' => 0, 'seller_access_status' => 1, 'admin_access_status' => 1, 'staff_access_status' => 1, 'created_at' => now(), 'updated_at' => now()],
        ...
        array_push($sql, ['delivery_process_id' => null, 'event' => 'Product review', 'type' => 'system', 'message' => 'Product review.', 'user_access_status' => 0, 'seller_access_status' => 1, 'admin_access_status' => 1, 'staff_access_status' => 1, 'created_at' => now(), 'updated_at' => now()]);
        array_push($sql, ['delivery_process_id' => null, 'event' => 'Product disable', 'type' => 'system', 'message' => 'Product disable.', 'user_access_status' => 0, 'seller_access_status' => 1, 'admin_access_status' => 1, 'staff_access_status' => 1, 'created_at' => now(), 'updated_at' => now()]);
