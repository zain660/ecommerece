...
class ReportService
{
    ...
    public function profit(array $request): array
    {
        ...
        $data['expense'] = $this->transactionRepository->getTotalAmountByParamFilterByDate(['type' => 'out','come_from' => ['sales_income','income','expense','sales_expense','wallet_recharge','payroll_expense','installment_income','loan_expense','refund_seller_commis']], $data['start'], $data['end']);
